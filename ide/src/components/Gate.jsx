...
export default function Gate({ onOk }) {
  ...
  return <div className="gate"><div className={"card" + (shake ? " shake" : "")}>
    ...
    <div className="field"><KeyRound size={15} color="var(--text-tertiary)" /><input autoFocus autoCapitalize="characters" spellCheck={false} placeholder="ACCESS CODE" value={v} onChange={e => setV(e.target.value)} onKeyDown={e => e.key === "Enter" && go()} /></div>
